...
describe 'A game of rock paper scissors' do
  ...
  describe 'playing' do
    ...
    context 'rock vs scissors' do
      it 'announces the correct winner with rock and scissors' do
        game = Game.new
        game.start
    ...
    context 'rock vs paper' do
      it 'announces the correct winner with rock and paper' do
        game = Game.new
        game.start
    ...
    context 'scissors vs paper' do
      it 'announces the correct winner with scissors and paper' do
        game = Game.new
        game.start
    ...
    context 'a tie game' do
      it 'announces that a game is tied' do
        game = Game.new
        game.start
